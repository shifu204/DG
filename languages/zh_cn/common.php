...
$_LANG['cart_info'] = "<strong>%d</strong>件";
...
$_LANG['reg_now'] = '立即注册';
$_LANG['constant_sex'][MALE] = '男';
$_LANG['constant_sex'][FEMALE] = '女';
$_LANG['constant_sex'][MID_SEX] = '保密';
...
$_LANG['hard_to_buy'] = '温馨提示：如果您在购物时遇到困难，请及时联系德贝客服。';
$_LANG['pass_shenhe'] = '通过审核';
$_LANG['not_pass_shenhe'] = '未审核';
$_LANG['no_related_info'] = '暂无相关信息';
$_LANG['require_login'] = '请求需要用户登录';
$_LANG['bonus_not_exist'] = '红包不存在';
$_LANG['no_register_operate'] = '非法操作';
$_LANG['over_bonus_num'] = '您已领取过该红包';
