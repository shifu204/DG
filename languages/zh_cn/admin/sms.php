...
//--短信模板
$_LANG['sms_template_t'] = '模板标题';
$_LANG['sms_template_u'] = '发送对象';
$_LANG['sms_template_c'] = '模板内容';

$_LANG['js_languages']['no_template_subject'] = '没有输入模板的名称';
$_LANG['js_languages']['template_content'] = '没有输入模板的内容';
$_LANG['js_languages']['template_user'] = '没有选择发送用户';

$_LANG['template_subject_exist'] = '模板名 %s 已经存在';

$_LANG['template_succed'] = '已成功添加';

$_LANG['back_list'] = '返回短信模板';
$_LANG['templates_add'] = '继续添加模板';

$_LANG['sms_edit'] = '短信模板编辑';

$_LANG['template_edit_succed'] = '短信模板编辑成功';

$_LANG['template_remove'] = '模板已成功删除';
