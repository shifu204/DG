...
$_LANG['lable_box']['to_buy'] = '订单-商家给客户的留言';
$_LANG['lable_box']['month_code'] = '订单-月结号';
$_LANG['lable_box']['is_cod'] = '√-订单-是否货到付款';
$_LANG['lable_box']['goods_amount'] = '订单-商品金额';
$_LANG['lable_box']['cod_code'] = '订单-代收货购号码';
$_LANG['lable_box']['pigeon'] = '√-对号';
$_LANG['lable_box']['pigeon2'] = '√-对号2';
$_LANG['lable_box']['pigeon3'] = '√-对号3';
$_LANG['lable_box']['pigeon4'] = '√-对号4';
$_LANG['lable_box']['pigeon5'] = '√-对号5';
