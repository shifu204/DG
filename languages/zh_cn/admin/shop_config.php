...
$_LANG['cfg_desc']['ym'] = '如果您有多个邮件地址，请在每个号码之间使用半角逗号（,）分隔。';
...
/*用户相关*/
$_LANG['cfg_name']['user']   = '用户相关';
$_LANG['cfg_name']['email_validate_points']   = '验证邮件送积分';
$_LANG['cfg_name']['mobile_validate_points']   = '验证手机送积分';
