...
$_LANG['cp_home'] = '管理中心';
$_LANG['copyright'] = 'ECSHOP版权所有，并保留所有权利。';
...
$_LANG['pinglun_add'] = '批量添加评论';
$_LANG['shaidan_add'] = '管理晒单'; 
$_LANG['16_day_promotion'] = '天天特价';
$_LANG['03_51activity'] = '2015五一活动';
...
$_LANG['11_add_order'] = '批量添加订单'; //PGCAO 20130521A增加
...
$_LANG['11_users_add'] = '会员批量添加';//PGCAO 20130521A增加
...
$_LANG['07_sms_template'] = '短信模板';

$_LANG['sms_add'] = '添加短信模板';
...
/*点击来源*/
$_LANG['from'][TRACE_FROM_ECS] = '电脑端';
$_LANG['from'][TRACE_FROM_ECT] = '移动端';

/*浏览操作*/
$_LANG['action'][TRACE_NORMAL] = '普通浏览';
$_LANG['action'][TRACE_ORDER_SUBMIT] = '提交订单';
$_LANG['action'][TRACE_USER_REGISTER] = '注册会员';
?>