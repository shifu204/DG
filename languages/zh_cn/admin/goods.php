...
$_LANG['goods_same_id'] = '同类ID';
$_LANG['goods_short_name'] = '简称';
...
$_LANG['not_hot'] = '取消热销';
$_LANG['move_to'] = '转移到分类';
$_LANG['move_to_extend_cat'] = '添加到扩展分类';
$_LANG['move_out_extend_cat'] = '取消扩展分类';
$_LANG['relate_goods'] = '关联商品';
$_LANG['copy_goods'] = '复制商品';
...
$_LANG['js_languages']['confirm_copy_goods'] = '您确定要复制选中的商品吗？';
