...
$_LANG['largess'] = '赠品';
$_LANG['shopping_money'] = '总计<font class="color5">（全场免运费）</font>： <em>%s</em>';
...
$_LANG['no_consignee'] = '您必须选择收货信息。';
$_LANG['select_one_bonus'] = '请选择红包：';
...
$_LANG['flow_js']['mobile_numbers_err'] = '手机号码必须是11位';
...
$_LANG['shipping_not_select'] = '请选择一种配送方式。';
$_LANG['payment_not_select'] = '请选择一种支付方式。';
