...
/* 我的晒单 */
$_LANG['shaidan_title'] = '晒单主题';
$_LANG['shaidan_goods_name'] = '晒单商品';
$_LANG['shaidan_time'] = '晒单时间';
$_LANG['reply_time'] = '回复时间';
$_LANG['shaidan_reply'] = '评论回复';
$_LANG['send_shaidan'] = '我要晒单';
$_LANG['shaidan_type'] = '晒单类型';
$_LANG['shaidan_content'] = '晒单内容';
$_LANG['submit_shaidan'] = '立即发表';
$_LANG['shaidan_img'] = '上传图片';
$_LANG['shaidan_name'] = '图片名称';
$_LANG['shaidantype'][0] = '晒晒商品';
$_LANG['shaidantype'][1] = '晒快递单';
$_LANG['shaidantype'][2] = '随便晒晒';
$_LANG['shaidan_title_empty'] = '晒单主题为空';
$_LANG['goods_has_shared'] = '该商品已晒单';
$_LANG['add_shaidan_success'] = '发表晒单成功';
$_LANG['shaidan_list_lnk'] = '返回晒单列表';
