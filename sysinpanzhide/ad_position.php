...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $position_tag  = !empty($_POST['position_tag']) ? trim($_POST['position_tag']) : '';
    ...
    {
        /* 将广告位置的信息插入数据表 */
        $sql = 'INSERT INTO '.$ecs->table('ad_position').' (position_name, position_tag, ad_width, ad_height, position_desc, position_style) '.
               "VALUES ('$position_name', '$position_tag', '$ad_width', '$ad_height', '$position_desc', '$_POST[position_style]')";
