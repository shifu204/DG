...
elseif ($_REQUEST['act'] == 'insert')
{
    ...
    $sort_order = !empty($_POST['sort_order']) ? intval($_POST['sort_order']) : 50;
    ...
    /* 插入数据 */
    $sql = "INSERT INTO ".$ecs->table('ad'). " (position_id,media_type,ad_name,ad_link,ad_code,start_time,end_time,sort_order,link_man,link_email,link_phone,click_count,enabled)
