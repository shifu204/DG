...
$modules['02_cat_and_goods']['09_goods_attr']       = 'goods_type.php?act=goods_attr_list';//商品属性
...
$modules['02_cat_and_goods']['pinglun_add']         = 'mc_comment.php';//PGCAO 20130521A增加
//$modules['02_cat_and_goods']['shaidan_add']         = 'mc_shaidan.php';//PGCAO 20130521A增加

//$modules['03_promotion']['03_51activity']       = 'activity/51activity.php?act=list'; //2015年51活动
$modules['03_promotion']['04_bonustype_list']       = 'bonus.php?act=list';
$modules['03_promotion']['09_topic']                = 'topic.php?act=list';
$modules['03_promotion']['16_day_promotion']       = 'day_promotion.php?act=list';
...
//$modules['04_order']['11_add_order']                = 'mc_order.php';//PGCAO 20130521A增加
...
$modules['06_stats']['searchengine_baidu']          = 'engine_baidu.php?act=keywords_list';
...
$modules['08_members']['11_users_add']    	    = 'mc_user.php';//PGCAO 20130521A增加
...
$modules['14_sms']['07_sms_template']                   = 'sms.php?act=sms_template';
