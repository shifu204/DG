...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        <a href="/sysinpanzhide/goods.php?act=ueditor_goods_desc&goods_id=<?php echo $this->_var['goods']['goods_id']; ?>" target="_blank" style="background: #80BDCB;padding:5px 8px; color: #FFF;" ><?php echo $this->_var['lang']['tab_detail']; ?></a>
        <span class="tab-back" id="mix-tab"><?php echo $this->_var['lang']['tab_mix']; ?></span>
        <?php if ($this->_var['goods_type_list']): ?><span class="tab-back" id="properties-tab"><?php echo $this->_var['lang']['tab_properties']; ?></span><?php endif; ?>
        ...
        <?php if ($this->_var['code'] == ''): ?><span class="tab-back" id="groupgoods-tab"><?php echo $this->_var['lang']['tab_groupgoods']; ?></span><?php endif; ?>
        <span class="tab-back" id="article-tab"><?php echo $this->_var['lang']['tab_article']; ?></span>
      </p>
    </div>
        ...
        <?php echo $this->html_options(array('options'=>$this->_var['suppliers_list_name'],'selected'=>$this->_var['goods']['suppliers_id'])); ?>
         ...
         <?php endif; ?>
          <tr>
            ...
            <td><input id="shop_price" type="text" name="shop_price" value="<?php echo $this->_var['goods']['shop_price']; ?>" size="20" onblur="priceSetted()"/>
          ...
          <tr>
            ...
            <td>
			<input type="button" value="全部原价" onclick="makeShopPrice(1)" />
            <input type="button" value="全部等级价" onclick="makeShopPrice(0)" />
            <span id="user_price_box">
...
?>
              ...
              function makeShopPrice(is_shop_price) {
                  if (is_shop_price == 1) {
                      var price = document.getElementById("shop_price").value;
                  } else {
                      var price = -1;
                  }
                  var user_price_box = document.getElementById("user_price_box");
                  var user_price = user_price_box.getElementsByTagName("input");
                  for(var i = 0; i < user_price.length; i++) {
                      if (user_price[i].name == 'user_price[]') {
                        user_price[i].value = price;
                      }
                  }
              }
          </script>
...
?>
          ...
          <!--商品封面图-->
          <tr>
              <td class="label"><?php echo $this->_var['lang']['goods_index_img']; ?>：</td>
              <td>
                  <input type="file" name="goods_index_img" size="35"/>
                  <?php if(!empty($this->_var['goods']['goods_index_img'])):?>
...
<!--            <td><input type="text" name="goods_number" value="<?php echo $this->_var['goods']['goods_number']; ?>" size="20" <?php if ($this->_var['code'] != '' || $this->_var['goods']['_attribute'] != ''): ?>readonly="readonly"<?php endif; ?> /><br />-->
          ...
          <tr>
            ...
            <td><textarea name="seller_note" cols="40" rows="10"><?php echo $this->_var['goods']['seller_note']; ?></textarea><br />
