...
<table cellpadding="3" cellspacing="1">
  <tr>
    ...
    <th><a href="javascript:listTable.sort('goods_same_id'); "><?php echo $this->_var['lang']['goods_same_id']; ?></a><?php echo $this->_var['sort_goods_same_id']; ?></th>
    ...
    <th><a href="javascript:listTable.sort('is_tryonebuy'); ">一听</a><?php echo $this->_var['sort_is_tryonebuy']; ?></th>
    <th><a href="javascript:listTable.sort('is_buy_five'); ">买六</a></th>
    <th><a href="javascript:listTable.sort('is_buy_seven'); ">买九</a></th>
    <th><a href="javascript:listTable.sort('is_total_four'); ">共四</a></th>
    <th><a href="javascript:listTable.sort('is_total_two')">买二</a><?php echo $this->_var['sort_is_total_two']; ?></th>
...
?>
  <tr>
    ...
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><span onclick="listTable.edit(this, 'edit_goods_same_id', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['goods_same_id']; ?></span></td>
    <td class="first-cell" style="<?php if ($this->_var['goods']['is_promote']): ?>color:red;<?php endif; ?>"><span onclick="listTable.edit(this, 'edit_goods_short_name', <?php echo $this->_var['goods']['goods_id']; ?>)"><?php echo $this->_var['goods']['goods_short_name']; ?></span></td>
    ...
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_tryonebuy']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_tryonebuy', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_buy_six']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_buy_six', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_buy_nine']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_buy_nine', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_total_four']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_total_four', <?php echo $this->_var['goods']['goods_id']; ?>)" /></td>
    <td align="center"><img src="images/<?php if ($this->_var['goods']['is_total_two']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_total_two', <?php echo $this->_var['goods']['goods_id']; ?>)"></td>
...
<div>
  ...
  <select name="type" id="selAction" onchange="changeAction()">
	...
	<?php endif; ?> 
    <option value="move_to_extend_cat"><?php echo $this->_var['lang']['move_to_extend_cat']; ?></option>
    <option value="move_out_extend_cat"><?php echo $this->_var['lang']['move_out_extend_cat']; ?></option>
    <option value="relate_goods"><?php echo $this->_var['lang']['relate_goods']; ?></option>
    <option value="copy_goods"><?php echo $this->_var['lang']['copy_goods']; ?></option>
  </select>
...
?>
  ...
  <select name="target_extend_cat" style="display:none;">
      <option value="0"><?php echo $this->_var['lang']['select_please']; ?></option>
      <?php echo $this->_var['cat_list']; ?>
  </select>
  <select name="target_out_extend_cat" style="display:none;">
      <option value="0"><?php echo $this->_var['lang']['select_please']; ?></option>
      <?php echo $this->_var['cat_list']; ?>
  </select>
  <!--end!-->
...
?>
  ...
  function confirmSubmit(frm, ext)
  {
      ...
      else if(frm.elements['type'].value == 'move_to_extend_cat' ){
          ext = (ext == undefined) ? true : ext;
          return ext && frm.elements['target_extend_cat'].value != 0;
      }
      else if(frm.elements['type'].value == 'move_out_extend_cat'){
          ext = (ext == undefined) ? true : ext;
          return ext && frm.elements['target_out_extend_cat'].value != 0;
      }
      else if (frm.elements['type'].value == '')
      {
          return false;
      } 
      else if (frm.elements['type'].value == 'copy_goods')
      {
          return confirm(confirm_copy_goods);
      }
      else
      {
          return true;
  ...
  function changeAction()
  {
     ...
     <?php endif; ?>
      frm.elements['target_extend_cat'].style.display = frm.elements['type'].value == 'move_to_extend_cat' ? '' : 'none';
      frm.elements['target_out_extend_cat'].style.display = frm.elements['type'].value == 'move_out_extend_cat' ? '' : 'none';
