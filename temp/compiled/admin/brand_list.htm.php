...
?>
    <tr>
      <td class="first-cell">
        <span style="float:right"><?php echo $this->_var['brand']['brand_logo']; ?></span>
      ...
      <td><?php echo $this->_var['brand']['count']; ?></td>
      ...
      <td align="center"><img src="images/<?php if ($this->_var['brand']['is_preferential_five']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_preferential_five', <?php echo $this->_var['brand']['brand_id']; ?>)" /></td>
      <td align="center"><img src="images/<?php if ($this->_var['brand']['is_preferential_seven']): ?>yes<?php else: ?>no<?php endif; ?>.gif" onclick="listTable.toggle(this, 'toggle_preferential_seven', <?php echo $this->_var['brand']['brand_id']; ?>)" /></td>
      <td align="center">
        <a href="/brand.php?id=<?php echo $this->_var['brand']['brand_id']; ?>" target="_blank" title="查看">查看</a> |
