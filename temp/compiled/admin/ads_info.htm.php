...
<form action="ads.php" method="post" name="theForm" enctype="multipart/form-data" onsubmit="return validate()">
  <table width="100%" id="general-table">
    ...
    <tr>
        ...
        <td>
            <input name="sort_order" type="text"  size="35" value='<?php echo $this->_var['ads']['sort_order']; ?>'  />
        </td>
    </tr>
...
<img src="<?php if (strpos ( $this->_var['ads']['ad_code'] , '://' )): ?><?php echo $this->_var['ads']['ad_code']; ?><?php else: ?>../data/afficheimg/<?php echo $this->_var['ads']['ad_code']; ?><?php endif; ?>" width="220"  border="0" />
</div>
<?php endif; ?>
</div>
