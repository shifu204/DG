...
class Common_util_pub
{
    ...
    function __construct($config = array()) {
        if(!empty($config)){
            ...
            $this->config['js_api_call_url'] = $config['js_api_call_url'];
            
            //=======【证书路径设置】=====================================
            //证书路径,注意应该填写绝对路径
            $this->config['sslcert_path'] = $config['sslcert_path'];
            $this->config['sslkey_path'] = $config['sslcert_path'];
            
            //=======【异步通知url设置】===================================
            //异步通知url，商户根据实际开发过程设定
            $this->config['notify_url'] = $config['notify_url'];
            $this->config['curlop_timeout'] = 30;
        }
    }
...
{	
    function __construct($config = array()) 
    {
        ...
        //设置curl超时时间
        $this->curl_timeout = $this->config['curlop_timeout'];
    }
