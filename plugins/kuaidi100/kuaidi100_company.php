<?php
	...
	}elseif ($typeCom == '圆通速递' || $typeCom == '圆通快递'){
		$typeCom = 'yuantong';
	...
	}elseif ($typeCom == '韵达快运' || $typeCom == '韵达快递'){
		$typeCom = 'yunda';
	}elseif ($typeCom == '源安达'){
		$typeCom = 'yuananda';
	}elseif ($typeCom == '运通快递'){
	...
	}elseif ($typeCom == 'EMS快递' || $typeCom == 'EMS 国内邮政'){
		$typeCom = 'ems';
	}elseif ($typeCom == '申通快递'){
		$typeCom = 'shentong';
	}elseif ($typeCom == '顺丰速运' || $typeCom == '顺丰到付'){
		$typeCom = 'shunfeng';
	}elseif ($typeCom == '中通速递' || $typeCom == '中通快递'){
		$typeCom = 'zhongtong';
	}elseif ($typeCom == '中邮物流'){
