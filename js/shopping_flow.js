...
function checkConsignee(frm)
{
  ...
  else if (frm.elements['mobile'] && frm.elements['mobile'].value.length > 0 && (!Utils.isTel(frm.elements['mobile'].value)))
  {
    err = true;
    msg.push(mobile_invaild);
  }
  else if (trim(frm.elements['mobile'].value).length != 11) {
	err = true;
	msg.push(mobile_numbers_err);
  }
