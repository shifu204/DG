...
class SplitWord
{
    ...
    public $addonDicFile = 'data/dict/words_addons.dic';
    ...
    public $mainDicFile = 'data/dict/base_dic_full.dic';
    //未编译的词典文件
    public $addonDicSourceFile = 'data/dict/base_dic_full.txt';
    ...
    {
        $this->addonDicFile = ROOT_PATH .$this->addonDicFile;
        $this->mainDicFile  = ROOT_PATH . $this->mainDicFile;
     ...
     */
     public function MakeDict( $source_file = '', $target_file='' )
     {
        ...
        if(empty($source_file)){
            $source_file = $this->addonDicSourceFile;
        }
