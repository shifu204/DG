...
class alipay
{
    ...
    function get_code($order, $payment)
    {
        ...
        $button = '<div style="text-align:center"><img style="cursor:pointer" src="js/zhifubao.jpg" onclick="window.open(\'https://mapi.alipay.com/gateway.do?'.$param. '&sign='.md5($sign).'&sign_type=MD5\')" alt="' .$GLOBALS['_LANG']['pay_button']. '" /></div>';
        $this->pay_href = "https://mapi.alipay.com/gateway.do?$param&sign=".md5($sign)."&sign_type=MD5";
        return $button;
    }
    
    function get_pay_href($order, $payment){
        $this->get_code($order, $payment);
        return $this->pay_href;
    }
