...
class chinabank
{
    ...
    function get_code($order, $payment)
    {
        ...
        $def_url .= '<input type=image title="' .$GLOBALS['_LANG']['pay_button']. '" src="js/wangyin.jpg" style="cursor:pointer;border:0px;width:220px;height:42px;">';
        $def_url .= "</form>";
    ...
    function get_pay_href($order, $payment){
        ...
        $def_url .= "<input type=HIDDEN name='remark1' value='".$remark1."'>";
        //$def_url .= "<input type=submit value='" .$GLOBALS['_LANG']['pay_button']. "'>";
        $def_url .= '<a id="pay_order_button"  title="' .$GLOBALS['_LANG']['pay_button']. '" href="javascript:document.getElementById(\''.$form_id.'\').submit();">立即支付</a>';
        $def_url .= "</form>";
        $this->pay_href = $def_url;
        return $def_url;
    }
