...
/*评论类型*/
define('GOODS_COMMENT',             0); //商品评论
define('SHAIDAN_COMMENT',           1); //晒单评论
define('ARTICLE_COMMENT',           2); //文章评论
define('REPLY_COMMENT',             3); //回复评论
...
define('SEND_BY_USER_GET',          5); // 用户点击领取
...
define('ACT_SHAIDAN',               3);     //晒单返还
define('ACT_EMAIL_VALIDATE',        4);     //会员绑定邮件赠送积分
define('ACT_MOBILE_VALIDATE',       5);     //会员绑定手机赠送积分
...
/* 新增 */
define('BUY_SEVEN_QTY', 7);
define('BUY_FIVE_QTY', 5);
define('FLOOR_TAB_QTY', 10);
define('FLOOR_GOODS_QTY', 8);
define('VALID_SHARE_ORDER_TIME', 1397164757 - 3600 * 8);

/*新增订单状态*/
define('ORDER_NO_PAY', 'no_pay');
define("ORDER_VALID", "order_valid");

/*记录访问页面表来源*/
define('TRACE_FROM_ECS', 1);
define('TRACE_FROM_ECT', 2);
/*记录访问页面表action码*/
define('TRACE_NORMAL', 0);  //普通操作
define('TRACE_ORDER_SUBMIT', 1);  //提交订单
define('TRACE_USER_REGISTER', 2);  //用户注册
?>
