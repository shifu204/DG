...
<div class="con"> 
    <header class="ect-header ect-margin-tb ect-margin-lr header-logo">
        <img class="etc-header-logo" src="<?php echo RELATIVE_ROOT_PATH;?>themes/debei/images/logo.png" />
        <?php if ($this->_var['user_name']): ?>
        <div class="ect-header-username f_r">
            欢迎您，<?php echo $this->_var['user_name']; ?>
        </div>
        <?php endif; ?>
    </header>
