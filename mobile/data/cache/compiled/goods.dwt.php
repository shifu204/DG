  ...
  <div class="goods-info ect-padding-tb"> 
    ...
    <section class="ect-margin-tb ect-margin-lr ">
      ...
      <p><?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?><?php echo $this->_var['lang']['promote_price']; ?><?php else: ?><?php echo $this->_var['lang']['shop_price']; ?><?php endif; ?><?php if ($this->_var['goods']['is_promote'] && $this->_var['goods']['gmt_end_time']): ?> 
        ...
        <?php endif; ?> <small> <del><?php if ($this->_var['cfg']['SHOW_MARKETPRICE']): ?><?php echo $this->_var['goods']['market_price']; ?> <?php endif; ?></del></small></p>
    </section>
...
?>
      ...
      <a class="ect-padding-lr ect-padding-tb" href="<?php echo url('goods/comment_list',array('id'=>$this->_var['goods']['goods_id']));?>"><span class="Text"><?php echo $this->_var['lang']['goods_comment']; ?></span> <span class="pull-right"><span class="ect-color"><?php echo $this->_var['comments']['count']; ?></span><?php echo $this->_var['lang']['comment_num']; ?> <span class="ect-color"><?php echo $this->_var['comments']['favorable']; ?>%</span><?php echo $this->_var['lang']['favorable_comment']; ?> <i class="fa fa-chevron-right"></i></span></a>      
        ...
        <?php if ($this->_var['goods']['same_goods']): ?>
        <section class="same-goods-div">
            <div class="ect-padding-lr ect-padding-tb">
                <p class="same-goods-title">优惠套装</p>
                <ul>
                    <?php $_from = $this->_var['goods']['same_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'sgoods');if (count($_from)):
    foreach ($_from AS $this->_var['sgoods']):
?>
                    <a href="<?php echo $this->_var['sgoods']['url']; ?>">
                        <li class="goods-item col-xs-4" title="<?php echo $this->_var['sgoods']['goods_name']; ?>">
                            <div class="goods-img"><img src="<?php echo $this->_var['sgoods']['goods_thumb']; ?>" /></div>
                            <div class="goods-price"><?php echo $this->_var['sgoods']['shop_price_formated']; ?></div>
                            <?php if ($this->_var['sgoods']['is_buy_nine']): ?>
                                <img class="buy_more_send_x" src="<?php echo $this->_var['template_dir']; ?>/images/icons/buy_nine_give_two_orange.png" />
                            <?php endif; ?>
                            <?php if ($this->_var['sgoods']['is_buy_six']): ?>
                                <img class="buy_more_send_x" src="<?php echo $this->_var['template_dir']; ?>/images/icons/buy_six_give_one_yellow.png" />
                            <?php endif; ?>
                            <?php if ($this->_var['sgoods']['is_total_four']): ?>
...
?>
 ...
 <!-- <div class="goods-related ect-padding-lr ect-padding-tb">
    ...
    <div id="picScroll" class="picScroll">
      ...
      <div class="bd">
        <ul>
          <?php $_from = $this->_var['related_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_18141900_1450535914');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_18141900_1450535914']):
        $this->_foreach['goods']['iteration']++;
?>
          <li><a href="<?php echo $this->_var['goods_0_18141900_1450535914']['url']; ?>"><img _src="<?php echo $this->_var['goods_0_18141900_1450535914']['goods_thumb']; ?>" src="<?php echo $this->_var['goods_0_18141900_1450535914']['goods_thumb']; ?>" /></a>
            <p class="ect-color"> 
              <?php if ($this->_var['goods_0_18141900_1450535914']['promote_price']): ?> 
              <?php echo $this->_var['goods_0_18141900_1450535914']['formated_promote_price']; ?>
              <?php else: ?> 
              <?php echo $this->_var['goods_0_18141900_1450535914']['shop_price']; ?>
              <?php endif; ?> 
            </p>
            <p class="text-left"><?php echo $this->_var['goods_0_18141900_1450535914']['short_name']; ?></p>
          </li>
