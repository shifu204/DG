      ...
      <form action="javascript:;" onsubmit="submitComment(this)" method="post" name="commentForm" id="commentForm">
        <div class="ect-padding-lr">
          ...
          <p class="ect-padding-tb code"><span>
            ...
            </span> <img class="pull-right" src="<?php echo url('public/captcha', array('rand'=>$this->_var['rand']));?>" alt="captcha" onClick="this.src='<?php echo url('public/captcha', array('rand'=>'Math.random()'));?>'"  /> </p>
          <?php endif; ?>
          <p class="ect-padding-tb">
