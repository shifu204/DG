...
?>
    ...
    <p> <a href="<?php echo url('user/order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>" type="button" class="btn btn-info ect-btn-info ect-colorf ect-bg"><?php echo $this->_var['lang']['order_tracking']; ?></a> </p>
    <?php endif; ?> 
  </div>
  <?php if ($this->_var['order']['order_amount'] > 0): ?>
	<section class="ect-padding-lr ect-padding-tb ect-margin-tb ect-margin-bottom0"><?php echo $this->_var['order']['pay_online']; ?></section>
  <?php endif; ?>
...
?>
      <li><a href="<?php echo url('goods/index', array('id'=>$this->_var['goods']['goods_id']));?>" target="_blank"><img src="<?php echo $this->_var['goods']['goods_thumb']; ?>"></a>
        <dl>
          ...
          <dd class="dd-price"><b ><?php echo $this->_var['lang']['ws_subtotal']; ?>：<span class="ect-colory"><?php echo $this->_var['goods']['subtotal']; ?></span></b></dd>
        </dl>
      </li>
      <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
    </ul>
...
<div class="two-btn ect-padding-tb ect-padding-lr ect-margin-tb text-center"> <?php echo $this->_var['order']['handler']; ?> 
  <?php if ($this->_var['order']['shipping_id']): ?><a class="btn btn-info ect-bg-colory" type="button" href="<?php echo url('order_tracking', array('order_id'=>$this->_var['order']['order_id']));?>"><?php echo $this->_var['lang']['order_tracking']; ?></a><?php endif; ?> 
</div>
