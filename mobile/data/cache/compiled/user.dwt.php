...
<div class="user-info">
  ...
  <dl class="pull-left">
    <dt>
      <h4>
          <?php if ($this->_var['info']['nickname']): ?>
          <?php echo $this->_var['info']['nickname']; ?>
          <?php else: ?>
          <?php echo $this->_var['info']['username']; ?>
          <?php endif; ?>
          | 
          <a href="<?php echo url('user/logout');?>" class="ect-colorf"><?php echo $this->_var['lang']['label_logout']; ?></a>
      </h4>
    </dt>
...
<section class="container-fluid user-nav">
  <ul class="row ect-row-nav text-center">
    ...
    <li class="col-sm-3 col-xs-3"><i class="fa fa-user"></i>
      <p class="text-center"><?php echo $this->_var['lang']['user_profile']; ?></p>
    </li>
