...
class CommonController extends BaseController
{
    ...
    {
        parent::__construct();
        //注册全局ecs,db变量以兼容ecshop的数据库调用语句
        $GLOBALS['ecs'] = self::$ecs;
        $GLOBALS['db'] = self::$db;
        $this->ecshop_init();    
        // 微信oauth处理
        ...
        $this->assign('template_dir','/themes/'. C('template'));
        /* 模板赋值 */
        assign_template();
    }
    ...
    protected function ecshop_init()
    {
        ...
        //记录访问记录
        //define('IN_ECS', TRUE);
        //require ECS_ROOT_PATH.'includes/cls_trace.php';
        //trace::trace_browse(0, '', TRACE_FROM_ECT);
    }
}
