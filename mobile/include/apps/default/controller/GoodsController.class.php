...
class GoodsController extends CommonController {
    ...
    public function index() {
        ...
        $goods['same_goods'] = model('Goods')->get_same_goods($this->goods_id);
        // 如果没有找到任何记录则跳回到首页
        if ($goods === false) {
            ecs_header("Location: ./\n");
        } else {
            ...
            if(!empty($goods['goods_same_id'])){
                $properties = model('Goods')->get_goods_properties($goods['goods_same_id']);
            } else {
            ...
            // 商品相册
            if(!empty($goods['goods_same_id'])){
                $pictures = model('GoodsBase')->get_goods_gallery($goods['goods_same_id']);
            } else {
                $pictures = model('GoodsBase')->get_goods_gallery($this->goods_id);
            }
