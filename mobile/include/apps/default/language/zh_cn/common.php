...
$_LANG['select_payment_method'] = "请选择支付方式";
$_LANG['check_out'] = "立即结算";
$_LANG['show_favourable'] = "查看优惠活动";
$_LANG['empty_shopping'] = "购物车什么都没有，赶快去购物吧";
$_LANG['go_shopping'] = "去购物";
$_LANG['shopping_cart'] = "购物车";
$_LANG['total_number'] = "件商品";
$_LANG['goods_price'] = "总价(不含运费)";
$_LANG['favourable_mz'] = "赠";
...
$_LANG['sort_price'] = '价格';
$_LANG['sort_buy_nine'] = '买九送二';
$_LANG['sort_buy_six'] = '买六送一';
$_LANG['sort_total_four'] = '四罐装';
$_LANG['like_num'] = '人喜欢';
$_LANG['scan_num'] = '次浏览';
...
$_LANG['art_no_keywords'] = "输入问题关键字搜索！";
/* 分页排序 */
...
$_LANG['five_stars'] = '非常好';
$_LANG['four_stars'] = '很好';
$_LANG['three_stars'] = '一般';
$_LANG['two_stars'] = '不行';
$_LANG['one_stars'] = '很差';
...
/* 积分兑换部分语言项 */
$_LANG['exchange'] = '积分商城';
$_LANG['exchange_num'] = '兑换量';
$_LANG['exchange_integral'] = '积分';
...
$_LANG['your_discount'] = '根据优惠活动<a href="'.url('activity/index').'"><font color=red>%s</font></a>，您可以享受折扣 %s';
$_LANG['no'] = '无';
