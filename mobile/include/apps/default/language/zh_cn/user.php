...
/* 取回密码 */
$_LANG['label_get_password'] = '您可通过';
$_LANG['photo_number'] = '手机号';
$_LANG['safe_question'] = '安全问题';
$_LANG['email'] = '电子邮件';
$_LANG['get_password'] = '找回密码';
$_LANG['reset_password'] = '重置密码';
$_LANG['back_home_lnk'] = '返回首页';
$_LANG['get_password_lnk'] = '返回获取密码页面';
$_LANG['get_password_by_question'] = '问题找回';
...
$_LANG['login'] = '登录';
$_LANG['sms_code_error'] = '验证码不匹配';
$_LANG['mobile_code_error'] = '手机验证码错误';
$_LANG['register_back'] = '重新注册';
$_LANG['msg_mobile_blank'] = '手机号不能为空';
$_LANG['msg_mobile_exists'] = '手机号已存在';
$_LANG['mobile_error'] = '手机号不正确或已被绑定';
$_LANG['next'] = '下一步';
