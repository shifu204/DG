    ...
    <form action="{url('edit')}" method="post" enctype="multipart/form-data" class="form-horizontal" role="form">
      <table id="general-table" class="table table-hover ectouch-table">
        ...
        <tr>
            ...
            <td>
                <div class="col-md-4">
                    <input type='text' name='data[m_tag]' maxlength="20" value='{$cat_info['m_tag']}' class="form-control input-sm" />
                </div>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <div class="col-md-4">
                    <div class="btn-group" data-toggle="buttons">
                      <label class="btn btn-primary btn-sm{if $cat_info['show_nav'] == '1'} active{/if}">
                      <input type="radio" name="data[show_nav]" id="show_nav1" value="1"{if $cat_info['show_nav'] == '1'} checked{/if}>
                      {$lang['yes']} </label>
                      <label class="btn btn-primary btn-sm{if $cat_info['show_nav'] == '0'} active{/if}">
                      <input type="radio" name="data[show_nav]" id="show_nav2" value="0"{if $cat_info['show_nav'] == '0'} checked{/if}>
                      {$lang['no']} </label>
                    </div>
                </div>
            </td>
