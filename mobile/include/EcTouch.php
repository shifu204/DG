...
defined('RELATIVE_ROOT_PATH') or define('RELATIVE_ROOT_PATH', str_replace(array('\\','//'),'/',dirname($_SERVER['SCRIPT_NAME']) . '/'));
...
defined('ECS_ROOT_PATH') or define('ECS_ROOT_PATH', str_replace('mobile', '', ROOT_PATH));
